...
>
> 💬 گروه‌های گفتگو برای اشتراک تحلیل (با امکان بلاک و گزارش)، و دستیار هوش مصنوعی شمعک برای جواب سؤال‌هات.
>
> 🏆 کارت‌های اشتراک: دوره‌ای که تموم کردی، رکورد روزهای پیاپی یا سود یه معامله رو به شکل یه کارت قشنگ برای دوستات بفرست.
>
> 🌍 فارسی و انگلیسی: کل اپ، با همه‌ی درس‌ها، به دو زبان. ورود با ایمیل یا شماره‌ی موبایل (ایران و بیش از ۱۰۰ کشور دیگه)، یا بدون حساب به‌عنوان مهمان.
>
